...
>>>>>>> 22a8cf87760399b4fc2440dd1ec17ef23d9b2b4b
...
<<<<<<< HEAD
        ...
        if (mySide == "Yellow") enemyColour = ECell.BlueWall;
        ...
        if (choseWisely == false) {
            ...
            if (nearestX > currentX && world.getBoard().get(currentY).get(currentX + 1) == enemyColour) {
                choseWisely = true;
                dir = EDirection.Right;
            }
            if (nearestX < currentX && world.getBoard().get(currentY).get(currentX - 1) == enemyColour) {
